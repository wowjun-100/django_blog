...
urlpatterns = [
    ...
    path('blogMain/detail/<int:blog_id>/edit/', blogapp.views.editBlog, name='editBlog'),
    path('blogMain/detail/<int:blog_id>/remove/', blogapp.views.removeBlog, name='removeBlog'),
    path('fail/', blogapp.views.fail, name='fail'),
